...
import { TaxFilingPeriodsQueryDto } from '../../../common/dto/resource-query.dto';
...
export class TaxFilingPeriodsController {
  ...
  findAll(@CurrentUser() user: AuthUser, @Query() query: TaxFilingPeriodsQueryDto) {
  ...
  update(
    @Param('id') id: string,
    @Body() dto: UpdateTaxFilingPeriodDto,
