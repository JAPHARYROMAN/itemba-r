...
import { ComplianceDocumentStatusQueryDto } from '../../../common/dto/resource-query.dto';
...
export class ComplianceDocumentStatusController {
  ...
  findAll(@CurrentUser() user: AuthUser, @Query() query: ComplianceDocumentStatusQueryDto) {
  ...
  update(
    @Param('id') id: string,
    @Body() dto: UpdateComplianceDocumentStatusDto,
