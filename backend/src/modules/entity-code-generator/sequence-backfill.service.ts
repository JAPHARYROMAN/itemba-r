...
const BACKFILL_TARGETS: BackfillTarget[] = [
  ...
  { entityType: 'FuelShift', prismaModel: 'fuelShift', numberField: 'shiftNumber' },
  { entityType: 'FuelDelivery', prismaModel: 'fuelDelivery', numberField: 'deliveryNumber' },
  { entityType: 'FuelCreditSale', prismaModel: 'fuelCreditSale', numberField: 'creditSaleNumber' },
  { entityType: 'FuelTankDip', prismaModel: 'fuelTankDip', numberField: 'dipNumber' },
  { entityType: 'GuestFolio', prismaModel: 'guestFolio', numberField: 'folioNumber' },
  ...
  { entityType: 'AgricultureActivity', prismaModel: 'agricultureActivity', numberField: 'activityNumber' },
  { entityType: 'EquipmentUsage', prismaModel: 'equipmentUsage', numberField: 'usageNumber' },
  { entityType: 'FarmInputApplication', prismaModel: 'farmInputApplication', numberField: 'applicationNumber' },
  { entityType: 'LaborRecord', prismaModel: 'laborRecord', numberField: 'laborRecordNumber' },
