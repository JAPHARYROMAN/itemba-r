...
export function QueueScreen({
  ...
  /**
   * Kaunta shell mode: rendered embedded inside the Leo day-book wrapper as
   * the pending (foleni) section — no page chrome of its own (no <main>, no
   * back button). Classic passes nothing — byte-identical.
   */
  slabMode?: boolean;
}) {
  const body = (
