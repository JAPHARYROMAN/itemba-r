...
export default function SalaryAdvancesPage() {
  ...
  return (
    <div className="p-6">
      <PageHeader title="Salary Advances" subtitle="Manage employee salary advance requests" />
      <PageToolbar
        actions={
          <Btn
            variant="primary"
                  ...
                  <tr key={a.id} className="border-b border-slate-50 hover:bg-slate-50">
                    ...
                    <td className={tdCls}>
                      ...
                      {Number.isFinite(Number(a.amount))
                        ? Number(a.amount).toLocaleString('en-TZ')
                        : '0'}
                    </td>
                    <td className={tdCls}>
                      {a.requestDate ? new Date(a.requestDate).toLocaleDateString('en-GB') : '—'}
                    </td>
                    <td className={tdCls}>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Btn variant="primary" type="submit" form="salary-advance-form" loading={saving}>
              Submit
            </Btn>
          </>
        }
