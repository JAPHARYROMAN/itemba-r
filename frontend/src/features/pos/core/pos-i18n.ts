...
const STRINGS = {
  en: {
    ...
    posTotalDue: 'Total to pay',
    posVatIncluded: 'All prices include VAT',
    posOutOfStock: 'Out of stock',
    posLowStock: 'Only {count} left',
    posLineOutOfStock: 'Stock shows none left',
    posLineStockShort: 'Stock shows only {count}',
    posStockWarning:
      'Some items are more than the stock shows. If the stock is right, the sale will be refused.',
    posEachPrice: '{price} each',
    posKeyHints: 'Enter adds · F8 customer · F12 pay',
    posSaleAt: 'Sale at {time}',
    posHeldTitle: 'Saved on this phone',
    // Price editing (POS remake phase 3)
    posEditPrice: 'Change price',
    posEditPriceOf: 'Change the price of {name}',
    posListPrice: 'List price',
    posNewPrice: 'New price',
    posReason: 'Reason',
    posReasonREGULAR_CUSTOMER: 'Regular customer',
    posReasonBULK_OFFER: 'Bulk offer',
    posReasonDAMAGED: 'Damaged item',
    posReasonOTHER: 'Other',
    posPriceNote: 'Note (optional)',
    posPriceDropOk: 'Discount {pct}% · within the {limit}% limit',
    posPriceDropOver: 'Discount {pct}% · more than the {limit}% limit',
    posPriceDropFree: 'Discount {pct}%',
    posPriceRise: 'Increase {pct}%',
    posPriceNoDrop: 'This terminal does not allow lowering prices.',
    posPriceRecorded: 'Price changes are recorded with your name.',
    posPriceChanged: 'price changed',
    posResetPrice: 'Use list price',
    posSave: 'Save',
    posCancel: 'Cancel',
    // Hardware (phase 4)
    posScannerReady: 'Scanner ready',
    posScanNotFound: 'No product with code {code} on this phone. Search results are below.',
    posPrintReceipt: 'Print receipt',
    posPrinting: 'Printing...',
    posPrinter: 'Printer and drawer',
    posPaper: 'Receipt paper',
    posPrinterBrowser: "Receipts print through this device's print dialog.",
    posConnectUsb: 'Connect a USB or serial printer',
    posConnectBluetooth: 'Connect a Bluetooth printer',
    posDisconnect: 'Disconnect',
    posPrinterConnected: 'Connected: {name}',
    posPrinterUncertified:
      'Direct printing is not yet certified for your printer model. Make a test print first.',
    posDrawerAfterCash: 'Open the cash drawer after a cash sale',
    posDrawerNeedsPrinter: 'The drawer opens through a directly connected printer.',
    posTestPrint: 'Test print',
    posPrinterFailed: 'The printer did not respond: {reason}',
    posClose: 'Close',
    posReceiptTitle: 'RECEIPT',
    posReceiptHeld: 'Saved on this phone - not yet sent',
    posReceiptThanks: 'Thank you for shopping with us',
    posReceiptReceived: 'Received',
    posReceiptChange: 'Change',
    posReceiptCustomer: 'Customer',
    posReceiptTotal: 'Total',
    errPriceNotAllowed: 'This price is not allowed for this product.',
    errPriceEditNotAllowed: 'You cannot change prices on this terminal.',
    errPriceReasonRequired: 'Choose a reason for the changed price.',
  ...
  sw: {
    ...
    posTotalDue: 'Jumla ya kulipa',
    posVatIncluded: 'Bei zote zinajumuisha VAT',
    posOutOfStock: 'Imeisha',
    posLowStock: 'Imebaki {count}',
    posLineOutOfStock: 'Stoo inaonyesha imeisha',
    posLineStockShort: 'Stoo inaonyesha {count} tu',
    posStockWarning: 'Baadhi ya bidhaa zimezidi stoo. Kama stoo iko sahihi, mauzo yatakataliwa.',
    posEachPrice: '{price} kila moja',
    posKeyHints: 'Enter ongeza · F8 mteja · F12 lipa',
    posSaleAt: 'Mauzo ya {time}',
    posHeldTitle: 'Imehifadhiwa kwenye simu',
    // Kubadilisha bei (POS mpya, awamu ya 3)
    posEditPrice: 'Badilisha bei',
    posEditPriceOf: 'Badilisha bei ya {name}',
    posListPrice: 'Bei ya orodha',
    posNewPrice: 'Bei mpya',
    posReason: 'Sababu',
    posReasonREGULAR_CUSTOMER: 'Mteja wa kudumu',
    posReasonBULK_OFFER: 'Ofa ya jumla',
    posReasonDAMAGED: 'Bidhaa ina kasoro',
    posReasonOTHER: 'Nyingine',
    posPriceNote: 'Maelezo (si lazima)',
    posPriceDropOk: 'Punguzo {pct}% · ndani ya kiwango cha {limit}%',
    posPriceDropOver: 'Punguzo {pct}% · zaidi ya kiwango cha {limit}%',
    posPriceDropFree: 'Punguzo {pct}%',
    posPriceRise: 'Ongezeko {pct}%',
    posPriceNoDrop: 'Kituo hiki hakiruhusu kupunguza bei.',
    posPriceRecorded: 'Mabadiliko ya bei yanahifadhiwa pamoja na jina lako.',
    posPriceChanged: 'bei imebadilishwa',
    posResetPrice: 'Rudisha bei',
    posSave: 'Hifadhi',
    posCancel: 'Ghairi',
    // Vifaa (awamu ya 4)
    posScannerReady: 'Scanner tayari',
    posScanNotFound:
      'Hakuna bidhaa yenye namba {code} kwenye simu. Angalia matokeo ya utafutaji hapa chini.',
    posPrintReceipt: 'Chapisha risiti',
    posPrinting: 'Inachapisha...',
    posPrinter: 'Printa na droo',
    posPaper: 'Karatasi ya risiti',
    posPrinterBrowser: 'Risiti zinachapishwa kupitia dirisha la kuchapisha la kifaa hiki.',
    posConnectUsb: 'Unganisha printa ya USB au serial',
    posConnectBluetooth: 'Unganisha printa ya Bluetooth',
    posDisconnect: 'Tenganisha',
    posPrinterConnected: 'Imeunganishwa: {name}',
    posPrinterUncertified:
      'Uchapishaji wa moja kwa moja bado haujathibitishwa kwa aina ya printa yako. Jaribu kuchapisha kwanza.',
    posDrawerAfterCash: 'Fungua droo ya pesa baada ya mauzo ya taslimu',
    posDrawerNeedsPrinter: 'Droo inafunguliwa kupitia printa iliyounganishwa moja kwa moja.',
    posTestPrint: 'Jaribu kuchapisha',
    posPrinterFailed: 'Printa haikujibu: {reason}',
    posClose: 'Funga',
    posReceiptTitle: 'RISITI',
    posReceiptHeld: 'Imehifadhiwa kwenye simu - bado haijatumwa',
    posReceiptThanks: 'Asante kwa kununua',
    posReceiptReceived: 'Amepokea',
    posReceiptChange: 'Chenji',
    posReceiptCustomer: 'Mteja',
    posReceiptTotal: 'Jumla',
    errPriceNotAllowed: 'Bei hii hairuhusiwi kwa bidhaa hii.',
    errPriceEditNotAllowed: 'Huwezi kubadilisha bei kwenye kituo hiki.',
    errPriceReasonRequired: 'Chagua sababu ya kubadilisha bei.',
    errOnePricePerProduct: 'Bidhaa moja inaweza kuwa na bei moja tu kwenye mauzo.',
  },
